    ...
    <div class="row">
        ...
        <div class="col-md-8">
         ...
         <div class="Input_Box">
           ...
           <div>名字：<input type="text" name="name" placeholder="" value="<?php echo (cookie('menberName')); ?>"/></div>
           <div>邮箱：<input type="text" name="email" placeholder="email:123@qq.com"value="<?php echo (cookie('menberEmail')); ?>"/></div>
           <div>主页：<input type="text" name="url" placeholder="http://" value="<?php echo (cookie('menberURL')); ?>"/></div>
           </div>
