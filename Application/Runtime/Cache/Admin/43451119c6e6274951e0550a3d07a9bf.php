...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-8">
		    <ol class="breadcrumb">
  <li><a href="/blog/index.php/Admin/Index">管理首页</a></li>
  <li><a href="/blog/index.php/Admin/Post/meta">分类管理</a></li>
  <?php if($meta): ?><li class="active">修改: <?php echo ($meta["name"]); ?></li>
  <?php else: ?>
      <li class="active">新建分类</li><?php endif; ?>
  
</ol>
<form action="/blog/index.php/Admin/Post/metaEdit/<?php echo ($meta["MID"]); ?>" method="post">
...
<script>
  ...
  modal.find("#deleteBottom").attr("href","/blog/index.php/Admin/Post/metaDelete/"+id);
})
</script>
		</div>
